= table_helper http://travis-ci.org/pluginaweek/table_helper.png

+table_helper+ adds a helper method for generating HTML tables from collections.

Now compatible with Rails 3.

== Resources

API

* http://rdoc.info/github/pluginaweek/table_helper/master/frames

Bugs

* http://github.com/pluginaweek/table_helper/issues
...
* http://travis-ci.org/pluginaweek/table_helper
...
To run against a specific version of Rails, use bundler:
